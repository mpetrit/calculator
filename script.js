...
function otherOperations (value){
    switch(value){
        ...
        case "+/-":
            if(whichNumber==0){
                firstNumber= firstNumber===Number(firstNumber)?firstNumber:Number(firstNumber.join(""))
                firstNumber/=-1
                ...
                .toString()
                .split("")
                .map((char) => (char === "-" || char === "." || char==="e") ? char : Number(char));
            }
            else{
                secondNumber===Number(secondNumber)?secondNumber:Number(secondNumber.join(""))
                secondNumber/=-1
        ...
        case "=":
            ...
            let n1= firstNumber===Number(firstNumber)?firstNumber:Number(firstNumber.join(""))
            let n2= secondNumber===Number(secondNumber)?secondNumber:Number(secondNumber.join(""))
